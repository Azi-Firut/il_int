...
// Camera offsets
      'J100': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[68][0]}' : '',
      'J101': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[68][1]}' : '',
      'J102': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[68][2]}' : '',
      'J103': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[69][0]}' : '',
      'J104': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[69][1]}' : '',
      'J105': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[69][2]}' : '',
      'J106': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[71][0]}' : '',
      'J107': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[71][5]}' : '',
      'I107': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[71][4]}' : '',
      'J108': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[71][3]}' : '',
      'I108': lidarOffsetsList.length > 36 ? '${lidarOffsetsList[71][2]}' : '',
// Brand logo
      'E6': '$appDirectory${brandImagesAtc['${listContentTxt[0]}']}',
      'E14': listContentTxt.length > 2 ? listContentTxt[1] : '',
// Bottom signature
