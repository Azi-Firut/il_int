...
//   }
//
//   Future<void> _wifiSearchPythonScript() async {
//     final result = await run(
//         'data/flutter_assets/assets/wifi_search/wifi_search.exe'); // Путь к вашему скрипту Python
//
...
//             onPressed: () => {_wifiSearchPythonScript()},
//             icon: Icon(
...
//               highlightColor: Colors.white24,
//               color: Colors.deepOrange,
//               onPressed: () => {_openFolderPythonScript()},
//               icon: Icon(
