...
sheet.name="Calibration Certificate";
  ...
  //  sheet.getRangeByName('B4:D14').cellStyle.borders.all.lineStyle = LineStyle.thin;
   ...
   final ByteData imageData = await rootBundle.load('assets/${listContentTxt[0]}.png');
    ...
    sheet.getRangeByName('B18').setText('IMU Type: ${fetchDataBase?.length != null ? fetchDataBase[3].text.trim() : ''}');
...
//
    ...
    sheet.getRangeByName('I20').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[34].text.trim() : '');
    ...
    sheet.getRangeByName('I21').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[35].text.trim() : '');
    ...
    sheet.getRangeByName('I22').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[26].text.trim() : '');
    ...
    sheet.getRangeByName('I24').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[30].text.trim() : '');
    ...
    sheet.getRangeByName('I25').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[31].text.trim() : '');
    ...
    sheet.getRangeByName('I26').setText(fetchDataBase?.length != null && fetchDataBase.length >= 20 ? fetchDataBase[22].text.trim() : '');
...
/// Lasers
    ...
    sheet.getRangeByName('I54').setText(lidarOffsetsList.length >= 16 ? '${lidarOffsetsList[15][1]}' : '');
    sheet.getRangeByName('J54').setText(lidarOffsetsList.length >= 16 ? '${lidarOffsetsList[15][2]}' : '');
  ...
  //  sheet.getRangeByName('J43').setText(lidarOffsetsList.length >= 4 && lidarOffsetsList[4].length == 2 ? '${lidarOffsetsList[4][2]}' : '');
    sheet.getRangeByName('J43').setText(lidarOffsetsList.length >= 4 && lidarOffsetsList[4].length > 2 ? '${lidarOffsetsList[4][2]}' : '');
